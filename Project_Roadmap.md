...
- **TECHNIQUES TO BE UTILIZED**
  - The techniques that we can explore for this include IDE based Agents for example SQL Agent, Research Agent, Plan Agent etc, GitHub Copilot, ChatGPT, Jira's AI Tool Rovo and other LLMs. 
  - The R&D will also include manual research and discussions with the stakeholders to make sure we are on the right track.

- **TIME ESTIMATES**
- For the R&D of whole project the estimate will be round about 400 - 500 hours.
...
- **Techniques** - Some of the initial technologies/techniques that we had listed as below. 
...
- Once we have decided the technologies, it will be clear if we need any assistance from other teams/team members.
...
- **Prototype:** A working prototype of basic admin UI for hub setup + simulated transmission. The prototype will follow the UI templates provided by Sakib and will be created taking fine care of the UX. This will be a 2-3 week process as there can be iterations. The prototype creation is an important step to be able to know what we are going to get at the end of the phase and to figure out any UI/UX level constraints that can arise over time and delay the actual implementation process.
...
#### Phase 2 — Intelligent Mapping System (Learning Enabled)
...
#### Phase 3 — User Permissions & Notifications
...
- **Discussions and planning:** Non-technical discussions and plan out the tickets that  will be created for implemented this thing and plan the sprint break up accordingly. Time taken will depend on the feedback cycle and amount of work needed
